    ...
    def findRestaurant(self, list1: List[str], list2: List[str]) -> List[str]:
        ...
        while i < len(list1):
            ...
            while j < len(list2):
                if list1[i] == list2[j]:
                    index_sum = i + j
                    if index_sum == min_index_sum or (index_sum < min_index_sum and len(res) == 0):
...
# arr = [[["Shogun", "Tapioca Express", "Burger King", "KFC"], ["KFC", "Shogun", "Burger King"]]]
arr = [
    ...
    [["KFC"], ["KFC"]],
    [["Shogun", "Piatti", "Tapioca Express", "Burger King", "KFC"], ["Piatti", "The Grill at Torrey Pines", "Hungry Hunter Steakhouse", "Shogun"]]
]

sol = Solution()
for el in arr:
    print(sol.findRestaurant(el[0], el[1]))
